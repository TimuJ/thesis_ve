...
\documentclass[
    ...
    % Thesis Info
    StudentName     = {Timur~Iakshibaev},
    StudentID       = 22321384,
    AdvisorName     = {Prof.~Zou~Changqing},
    Grade           = 2023,            % only the year, no '级'
    Major           = {Computer~Science~and~Technology},
    Department      = {Computer~Science~and~Technology},
    SubmitDate      = {2026.7.24},
    MajorFormat     = general,
    ...
    % Title
    Title           = {长视频超分辨率的长程一致性评价：度量设计与位置编码分析},
    TitleEng        = {{Long-Range Consistency Evaluation for Long-Video Super-Resolution: Metric Design and Positional-Encoding Analysis}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{长视频超分辨率的长程一致性评价：}{度量设计与位置编码分析}
\titleengtwolines{Long-Range Consistency Evaluation for Long-Video}{Super-Resolution: Metric Design and Positional-Encoding Analysis}
