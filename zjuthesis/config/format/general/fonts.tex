...
\ifthenelse{\equal{\csname g__ctex_fontset_tl\endcsname}{mac}}
{
    \IfFileExists{ /System/Library/Fonts/PingFang.ttc }
    {
        ...
        % Canonical fonts installed from examples/fonts (matches the CS
        % example theses exactly); Apple ST*/SC variants render differently.
...
{
    % Ubuntu/Linux platform - using available Chinese fonts
    \setCJKfamilyfont{zhfs}   {FangSong}               [AutoFakeBold={\FakeBoldSize}]
