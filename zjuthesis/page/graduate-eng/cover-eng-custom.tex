\cleardoublepage
\thispagestyle{cover}
\begingroup\linespreadsingle\selectfont
...
\begin{center}
    \includegraphics[width=0.44\paperwidth]{logo/zjuchar.pdf}
\end{center}
...
\begin{center}
    \includegraphics[width=0.12\paperwidth]{logo/zju.pdf}
\end{center}
...
\begin{center}
    ...
    \begin{tabularx}{.8\textwidth}{>{\fangsong}l >{\fangsong}X<{\centering}}
        ...
        {%
        Author：        & \uline{\hfill Not described due to blind peer review. \hfill} \\
        Supervisor：    & \uline{\hfill Not described due to blind peer review. \hfill} \\
        }
        {%
