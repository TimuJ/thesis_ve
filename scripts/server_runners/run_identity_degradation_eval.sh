#!/bin/bash
# Per-metric eval for identity_degradation synthetic artefact (10 videos).
# Modeled on run_flicker_eval.sh.
set -eo pipefail
DISK2=/data/disk2/timur
GPU=${1:-2}
SRC=$DISK2/results/synthetic_artefacts/identity_degradation
EVAL=$DISK2/results/synthetic_artefacts_eval
ART=identity_degradation
